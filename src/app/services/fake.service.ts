...
export class ApiServiceService {
  ...
  // post(url: string, data?: any, isFileUpload = false) {
  //   const httpOptions = this.getHttpHeader(isFileUpload);
  ...
  // getHttpHeader(isFileUpload = false) {
  //   let headerJson: any = {};

  //   if (!isFileUpload) {
  //     // ✅ Only set headers if NOT uploading a file
  //     if (this.getAuthToken() !== '') {
  //       headerJson['Authorization'] = this.getAuthToken();
  //     }
